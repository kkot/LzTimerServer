...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(kkot.lztimer.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(kkot.lztimer.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(kkot.lztimer.domain.User.class.getName() + ".authorities", jcacheConfiguration);
            cm.createCache(kkot.lztimer.domain.PersistentToken.class.getName(), jcacheConfiguration);
